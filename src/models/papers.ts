...
export const summaries: Summary[] = [
  ...
  },
  {
    ...
    detailed: "SAM은 프롬프트 기반 세그멘테이션을 수행합니다. 특정 도메인에 대한 학습 없이도 다양한 이미지에서 물체를 정확하게 분할할 수 있습니다. 이 모델은 Meta AI에서 개발했으며, 1,100만 개의 이미지와 11억 개의 마스크로 구성된 거대 데이터셋 SA-1B로 학습되었습니다. SAM은 point, box, text 등 다양한 형태의 프롬프트를 입력으로 받아서 이미지 내의 객체를 분할할 수 있습니다. 이를 통해 의료 영상, 위성 사진, 자율주행 등 다양한 도메인에서 추가 학습 없이도 뛰어난 성능을 발휘합니다. 모델 아키텍처는 이미지 인코더, 프롬프트 인코더, 마스크 디코더로 구성되어 있으며, 이를 통해 실시간으로 정밀한 분할 결과를 생성할 수 있습니다.",
    evidenceScope: "full",
  },
];
