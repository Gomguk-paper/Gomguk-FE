...
from database import SessionLocal, Paper, Summary
...
def generate_summary(paper: Paper) -> Optional[Dict]:
    ...
    if not OPENAI_API_KEY:
        print("Warning: OPENAI_API_KEY가 설정되지 않았습니다. 데모용 요약을 생성합니다.")
...
{{
  ...
  "evidence_scope": "abstract"
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "당신은 AI 논문을 전문적으로 요약하는 연구자입니다. 한국어로 명확하고 간결하게 요약해주세요."},
